    ...
    public void onBindViewHolder(BookAdapter.ViewHolder viewHolder, int position) {
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent BookDetails = new Intent(getContext(), BookDetailActivity.class);
                BookDetails.putExtra(Book.class.getSimpleName(), Parcels.wrap(book));
                view.getContext().startActivity(BookDetails);
            }
        });
    }
